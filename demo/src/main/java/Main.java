...
public class Main {
    public static void main(String[] args) {
        ...
        String url = "jdbc:mysql://localhost:3306/buct?useUnicode=true&characterEncoding=utf8&useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=GMT%2B8";
        FastAutoGenerator.create(url, "root", "030601")
