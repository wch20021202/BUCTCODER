CREATE TABLE IF NOT EXISTS `student` (
    ...
    `stu_class` varchar(255) DEFAULT NULL COMMENT'学生年级',
    `stu_ac_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT'学生atcoder的id',
    `stu_cf_id` varchar(255) DEFAULT NULL COMMENT'学生codeforce的id',
    PRIMARY KEY (`stu_no`)
    );
